...
object KeyCode {
    ...
    fun Int.checkAndConvertCode(): Int = if (this > 0) this else when (this) {
        ...
        SEND_INTENT_THREE, EMOJI_SEARCH, INLINE_EMOJI_SEARCH_DONE, RIZZSE, META_LOCK
        -> this
    ...
    @JvmStatic fun isIsBlockedWhenLocked(keyCode: Int) = when (keyCode) {
        SETTINGS, TOGGLE_FLOATING_WINDOW, CLIPBOARD, CLIPBOARD_PASTE, RIZZSE -> true
        else -> false
    }
}
